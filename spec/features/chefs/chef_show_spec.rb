...
RSpec.describe 'When I visit a chefs show page' do
  ...
  # it "shows an list of the chef's favorite_ingredients" do
  #   emeril = Chef.create(name: "Emeril Legasse")
  #
  #   red_sauce = Ingredient.create(name: "Red Sauce", calories: 200)
  #   beef = Ingredient.create(name: "Ground Beef", calories: 500)
  ...
  #
  #   wedding_soup = emeril.dishes.create(name: "Wedding Soup", description: "A warm bowl of deliciousness" )
  #   DishIngredient.create(ingredient_id: beef.id, dish_id: wedding_soup.id)
  #   DishIngredient.create(ingredient_id: lentils.id, dish_id: wedding_soup.id)
  #   DishIngredient.create(ingredient_id: parsley.id, dish_id: wedding_soup.id)
  #
  #   spaghetti = emeril.dishes.create(name: "Spaghetti", description: "Hot Noods" )
  #   DishIngredient.create(ingredient_id: beef.id, dish_id: spaghetti.id)
  #   DishIngredient.create(ingredient_id: oregano.id, dish_id: spaghetti.id)
  #   DishIngredient.create(ingredient_id: red_sauce.id, dish_id: spaghetti.id)
  #   DishIngredient.create(ingredient_id: parsley.id, dish_id: spaghetti.id)
  #
  #   alfredo = emeril.dishes.create(name: "Alfredo", description: "Cheesy Noods" )
  #   DishIngredient.create(ingredient_id: mozz.id, dish_id: alfredo.id)
  #   DishIngredient.create(ingredient_id: ricotta.id, dish_id: alfredo.id)
  #   DishIngredient.create(ingredient_id: parsley.id, dish_id: alfredo.id)
  #
  #
  #
  #   visit "/chefs/#{emeril.id}"
