...
ActiveRecord::Schema.define(version: 2020_10_29_153912) do
  ...
  add_foreign_key "dishes_ingredients", "dishes", column: "dishes_id"
  add_foreign_key "dishes_ingredients", "ingredients", column: "ingredients_id"
end
