...
ActiveRecord::Schema.define(version: 2021_01_08_193256) do
  ...
  create_table "ingredients_lists", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dish_id"], name: "index_ingredients_lists_on_dish_id"
  ...
  add_foreign_key "ingredients_lists", "dishes"
